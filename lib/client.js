...
window.__ModuleLoader__.load({ id: 'dsh-token-anxiety', factory: (require) => {
  ...
  var CSS = [
    ...
    '.txg-cc-x { border:none; background:transparent; color:inherit; opacity:.5; cursor:pointer; font-size:12px; padding:2px 4px; border-radius:4px; }',
    ...
    '.txg-cc-rate { font-size:12px; opacity:.55; flex:none; margin-left:4px; }',
    ...
    '.txg-num { position:absolute; right:4px; top:1px; font-size:12px; }',
    ...
    '.txg-tip { position:absolute; bottom:calc(100% + 4px); left:0; z-index:70; width:max-content; max-width:420px; background:#26262c; border:1px solid rgba(255,255,255,.18); border-radius:8px; padding:20px 10px 8px; font-size:12px; line-height:1.5; box-shadow:0 8px 24px rgba(0,0,0,.5); }',
    '.txg-tip-x { position:absolute; top:2px; left:2px; z-index:3; width:15px; height:15px; line-height:1; border:none; background:transparent; color:inherit; opacity:.55; cursor:pointer; border-radius:4px; font-size:12px; padding:0; }',
  ...
  function TokenAnxietyWidget(props) {
    ...
    function barGraph(t, maxCop, maxTok) {
      ...
      return React.createElement('div', { className: 'txg-bars' },
        ...
        React.createElement('div', { className: 'txg-muted', style: { fontSize: 12 } },
