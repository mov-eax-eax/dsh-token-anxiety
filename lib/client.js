...
window.__ModuleLoader__.load({ id: 'dsh-token-anxiety', factory: (require) => {
  ...
  var CSS = [
    '.txg-widget { display:inline-flex; align-items:center; gap:6px; font-size:11px; line-height:1; padding:3px 9px; border-radius:999px; background:rgba(160,160,160,.14); color:inherit; white-space:nowrap; }',
