...
window.__ModuleLoader__.load({ id: 'dsh-token-anxiety', factory: (require) => {
  ...
  var CSS = [
    ...
    '.txg-th-cost { width:170px; flex:none; }',
    '.txg-cell-cost { width:170px; flex:none; text-align:right; font-variant-numeric:tabular-nums; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }',
    ...
    if (tasks.length) {
      ...
      var rows = sortedTasks.map(function (t, i) {
        ...
        return React.createElement('div', {
          ...
          React.createElement('div', { className: 'txg-cell-cost', title: money(t.cop) + (showProj ? ' \u2192 ' + money(t.postCop) : '') },
            money(t.cop),
            showProj ? React.createElement('b', { className: 'txg-post' }, ' \u2192 ' + money(t.postCop)) : null),
      ...
      tasksTab = React.createElement('div', { className: 'txg-tasks' },
        React.createElement('div', { className: 'txg-sec' },
          React.createElement('div', { className: 'txg-sec-t' }, L.costPerTask.replace('{cur}', cur) + ' \u00b7 ' + money(conv.taskCount > 0 ? conv.totalCop / conv.taskCount : 0)),
